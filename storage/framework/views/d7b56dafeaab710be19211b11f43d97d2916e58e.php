...
Admin area: <?php echo e(trans('work:work_category_admin.page_edit')); ?>
...
<div class="row">
    <div class="col-md-12">
            ...
            <div class="panel panel-info">
                <div class="panel-heading">
                    <h3 class="panel-title bariol-thin">
                        <?php echo !empty($category->category_id) ? '
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-md-12 col-xs-12">
                            ...
                            <h4><?php echo trans('work::work_category_admin.form_heading'); ?></h4>
                            <?php echo Form::open(['route'=>['admin_work_category.post',
                            'id' => @$category->category_id],  'files'=>true, 'method' => 'post']); ?>

                            <!--END SAMPLE CATEGORIES ID  -->

                            <!-- CATEGORY NAME TEXT-->
                            <?php echo $__env->make('work::work_category.elements.text', ['name' => 'category_name'], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                            <!-- /END CATEGORY NAME TEXT -->
                            <!-- CATEGORY PARENT SELECT-->
                            <?php echo $__env->make('work::work_category.elements.select', ['name' => 'category_parent'], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                            <!-- /END CATEGORY PARENT SELECT-->
                            <!-- CATEGORY DESCRIPTION TEXT-->
                            <?php echo $__env->make('work::work_category.elements.text-area', ['name' => 'category_description'], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        ...
        <div class='col-md-4'>
            <?php echo $__env->make('work::work_category.admin.work_category_search', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        </div>
