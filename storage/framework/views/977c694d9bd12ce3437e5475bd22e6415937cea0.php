<div class="row margin-bottom-12">
    <div class="col-md-12">
        <a href="<?php echo URL::route('admin_work_category.edit'); ?>" class="btn btn-info pull-right">
            <i class="fa fa-plus"></i><?php echo e(trans('site::work_category_admin.work_category_add_button')); ?>
...
<ul class="tree">
    ...
    <li>
        ...
        <?php echo $__env->make('site::work_category.admin.work_category_child',['childs' => $category->childs], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        <?php else: ?>
            <span>
                <a href="<?php echo URL::route('admin_work_category.edit', ['id' => $category->category_id]); ?>">
                    <i class="fa fa-pencil"></i>
