...
<table class="table table-hover">
    <thead>
        <tr>
            <td style='width:5%'><?php echo e(trans('site::work_admin.order')); ?></td>
            
              <th style='width:20%'>Title</th>
              <th style='width:20%'>Category</th>
             <th style='width:10%'>Salary</th>
            <th style='width:5%'><?php echo e(trans('site::work_admin.operations')); ?></th>
        </tr>
    </thead>
    <tbody>
        <?php
...
<?php else: ?>
 <span class="text-warning">
	<h5>
		<?php echo e(trans('site::work_admin.message_find_failed')); ?>
